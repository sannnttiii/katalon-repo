...
WebUI.selectOptionByValue(findTestObject('Book Appointment/dropdown_facility'), 'Hongkong CURA Healthcare Center', false)
...
WebUI.setText(findTestObject('Book Appointment/date_Visit Date (Required)'), '02/07/2023')

WebUI.setText(findTestObject('Book Appointment/textarea_Comment'), '')
...
WebUI.verifyTextPresent('02/07/2023', false)
