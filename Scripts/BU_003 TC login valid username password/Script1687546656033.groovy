...
WebUI.click(findTestObject('Toggle menu/menu-toggle_Login'))
...
WebUI.setText(findTestObject('Login/textbox_password'), GlobalVariable.GlobalPassword)
...
WebUI.verifyElementPresent(findTestObject('Toggle menu/menu-toggle_History'), 0)

WebUI.verifyElementPresent(findTestObject('Toggle menu/menu-toggle_Profile'), 0)

WebUI.verifyElementPresent(findTestObject('Toggle menu/menu-toggle_Logout'), 0)
