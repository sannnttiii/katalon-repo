...
WebUI.setText(findTestObject('Login/textbox_username'), 'john deo')

WebUI.setText(findTestObject('Login/textbox_password'), 'thisisapassword')

WebUI.click(findTestObject('Login/button_Login'))

WebUI.waitForElementPresent(findTestObject('Login/text_Login failed Please ensure the username and password are valid'), 
    0)
